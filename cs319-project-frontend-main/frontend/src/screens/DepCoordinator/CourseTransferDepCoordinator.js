...
export default function CourseTransferDepCoordinator() {
    const selectors = [
        "A",
    ]
    const headersEmpty = [];
        ...
        <Box sx={{ flexGrow: 1 }}>
            ...
            <Grid container>
                ...
                <Grid item xs={3} sx={{ mt: 4 }}>
                    ...
                    <Button style={{ backgroundColor: "#201F2B" }} variant="contained">Download</Button>
                </Grid>
                <Grid item xs={3} sx={{ mt: 4 }}>
                    <Typography variant="body1" gutterBottom>
                        Upload Form With Signature
                    </Typography>
                    <Button style={{ backgroundColor: "#201F2B" }} variant="contained">Upload</Button>
                </Grid>
            </Grid>
        </Box>
    )
